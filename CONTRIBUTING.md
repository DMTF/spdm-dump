# Contributing to spdm-dump

Thank you for your interest in contributing to spdm-dump, the DMTF tool for
parsing and dumping [SPDM](https://www.dmtf.org/standards/spdm) and secured
message traffic.
...
spdm-dump is licensed under the BSD 3-Clause License (see [LICENSE.md](LICENSE.md)).
